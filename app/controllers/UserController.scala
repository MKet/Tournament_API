...
@Singleton
class UserController @Inject()(cc: ControllerComponents, sf: ServiceFactory, jwtService: JwtService)(implicit ec: ExecutionContext) extends AbstractController(cc) {
